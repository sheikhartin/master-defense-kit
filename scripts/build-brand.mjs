 ...
 * اجرا: npm run icons
 *
 * نشان: «سپر و صدا» - سپر طلایی با میکروفون کرم روی پس‌زمینه مشکی.
 * همه آیکون‌ها (نصب، تب، سربرگ) همان نشان ثابت هستند و با پالت‌های
 * برنامه عوض نمی‌شوند (تصمیم D13 در docs/PLAN.md). فقط رنگ‌های رابط
 * (دکمه، ناوبری، پیشرفت) از پالت‌ها می‌آیند.
 *
